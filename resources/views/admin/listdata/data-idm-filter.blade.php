...
<div class="container">
    ...
    <div class="card mt-2">
        <h5 class="card-header text-white bg-dark">
            <a class="d-inline-flex btn btn-success float-right" href="{{ route('index-print-idm') }}">PRINT DATA</a>
            Data Indeks Desa Membangun</h5>
        <div class="card-body">
            ...
            <div class="container">
                <a href="{{ url('/admin/data/data-indeks-desa-membangun') }}" class="btn btn-primary float-left mt-3">Kembali</a>
            </div>

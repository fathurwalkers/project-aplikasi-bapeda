...
<div class="container">
    ...
    <div class="card mt-2">
        <h5 class="card-header text-white bg-dark">
            <a class="d-inline-flex btn btn-success float-right" href="{{ route('index-print-luastanam') }}">PRINT DATA</a>
            Data Luas Tanam</h5>
        <div class="card-body">
              ...
              <table id="table_id" class="display">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <a href="{{ url('/admin/data/edit-luas-tanam-satu') }}/{{$fk->id}}" class="btn btn-primary">Edit</a>
                            <form action="{{ url('/admin/data/delete-luas-tanam-satu') }}/{{ $fk->id }}" method="POST">
                                @csrf   

...
<div class="container">
    ...
    <div class="card mt-2">
        <h5 class="card-header text-white bg-dark">
            <a class="d-inline-flex btn btn-success float-right" href="{{ route('index-print-pendidikan') }}">PRINT DATA</a>
            Data Pendidikan</h5>
        <div class="card-body">
              ...
              <table id="table_id" class="display">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <a href="{{ url('/admin/data/data-pendidikan/edit') }}/{{$fk->id}}" class="btn btn-primary">Edit</a>
            ...
            <div class="container">
                <a href="{{ url('/admin/data/data-pendidikan') }}" class="btn btn-primary float-left mt-3">Kembali</a>
            </div>

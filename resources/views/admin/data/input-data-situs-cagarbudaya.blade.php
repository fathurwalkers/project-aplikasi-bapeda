...
<div class="container mt-2">
  <div class="card">
    ...
    <div class="card-body">
      <form action="{{ route('post-cagar-budaya') }}" method="POST">
        @csrf
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input name="situscagarbudaya" type="text" class="form-control" id="inputjumlah"
              placeholder="Masukkan Cagar Budaya...">
          </div>
        </div>
        <div class="form-group row">

...
<div class="container"> 
    <div class="card mt-3">
        <h5 class="card-header">Input Data Catatan Sipil Menurut Mata Pencaharian</h5>
        <div class="card-body">
        <div>
            ...
            <form action="" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="matapencaharian" class="form-control" id="exampleFormControlSelect1">
                        <option hidden>Mata Pencaharian</option>
                        <option>PNS</option>

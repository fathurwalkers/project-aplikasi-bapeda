...
<div class="container mt-2">
    <div class="card">
        ...
        <div class="card-body">
        <form action="{{ url('/admin/data/post-data-fasilitas-kesehatan') }}" method="POST">
                @csrf
                <div class="form-group row">
                    <label for="inputFalisitas" class="col-sm-2 col-form-label">Falisitas Kesehatan </label>
                    <div class="col-sm-10">
                      <input name="fasilitas_kesehatan" type="text" class="form-control" id="inputFalisitas" placeholder="Masukkan Nama Fasilitas Kesehatan...">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input name="kabupaten" type="text" class="form-control" id="inputkabupaten" placeholder="Masukkan Nama Kabupaten...">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-2">
                        ...
                        <input name="jumlah" type="number" min="0" step="1" class="form-control" pattern="[0-9]">
                    </div>
                </div>

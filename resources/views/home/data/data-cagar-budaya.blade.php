...
@section('main-content')
        ...
        <main id="main">
          ...
          <div class="container mb-4">
            <a href="{{ route('index-print-kebudayaan')}}" class="btn btn-primary" target="_BLANK">PRINT PDF</a>
            <div class="card mt-2">
                <h5 class="card-header text-white bg-dark">Data Situs Cagar Budaya</h5>
                <div class="card-body">
                
                    <div class="table-responsive py-3"> 
                      <h6 class="font-italic text-muted">Sumber Data : Dinas Kebudayaan</h6>
                        <table class="table table-bordered table-hover">
                          <thead class="thead-dark text-center">
                            <tr>
                              ...
                              <th scope="col">Situs Cagar Budaya</th>
                          ...
                          <tbody>
                            ...
                            @foreach ($data_cagarbudaya as $row)
                            <tr>
                              <th scope="row">{{ $loop->iteration }}</th>
                              <td>{{ $row->tahun }}</td>
                              <td>{{ $row->kecamatan }}</td>
                              <td>{{ $row->situscagarbudaya }}</td>
                              <td>{{ $row->jumlah }}</td>
                            </tr>
                            @endforeach

...
@section('main-content')
        ...
        <main id="main">
          ...
          <div class="container mb-4">
            <a href="{{ route('index-print-tangkap')}}" class="btn btn-primary" target="_BLANK">PRINT PDF</a>
            <div class="card mt-2">
                <h5 class="card-header text-white bg-dark">Data Perikanan Jenis Tangkap</h5>
                <div class="card-body">
                      ...
                      <h6 class="font-italic text-muted">Sumber Data : Dinas Perikanan</h6>
                        <table class="table table-bordered table-hover">
                          ...
                          <tbody>
                            ...
                            @foreach ($data_perikanan_komodity as $row)
                            <tr>

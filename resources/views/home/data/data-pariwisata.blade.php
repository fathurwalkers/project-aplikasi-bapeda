...
@section('main-content')
        ...
        <main id="main">
          ...
          <div class="container mb-4">
            <a href="{{ route('index-print-pariwisata')}}" class="btn btn-primary" target="_BLANK">PRINT PDF</a>
            <div class="card mt-2">
                <h5 class="card-header text-white bg-dark">Data Pariwisata</h5>
                <div class="card-body">
                
                    <div class="table-responsive py-3"> 
                      <h6 class="font-italic text-muted">Sumber Data : Dinas Pariwisata</h6>
                        <table class="table table-bordered table-hover">
                          <thead class="thead-dark text-center">
                            <tr>
                              <th scope="col">No</th>
                              <th scope="col">Tahun</th>
                              <th scope="col">Manca Negara</th>
                          ...
                          <tbody>
                            ...
                            @foreach ($data_wisata as $fasilitas_kesehatan)
                            <tr>
                              <th scope="row">{{ $loop->iteration }}</th>
                              <td>{{ $fasilitas_kesehatan->tahun }}</td>
                              <td>{{ $fasilitas_kesehatan->mancanegara }}</td>
                              <td>{{ $fasilitas_kesehatan->domestik }}</td>

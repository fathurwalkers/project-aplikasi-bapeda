                        ...
                        <div class="nav">
                                ...
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            ...
                                            <a class="nav-link" href="{{ url('/admin/data/data-fasilitas-kesehatan/Pasarwajo') }}">Pasarwajo</a>

                                            <a class="nav-link" href="{{ url('/admin/data/data-fasilitas-kesehatan/Wolowa') }}">Wolowa</a>
                                            
                                            <a class="nav-link" href="{{ url('/admin/data/data-fasilitas-kesehatan/Siontapina') }}">Siontapina</a>
                                            
                                            <a class="nav-link" href="{{ url('/admin/data/data-fasilitas-kesehatan/Lasalimu_Selatan') }}">Lasalimu_Selatan</a>
                                            
                                            <a class="nav-link" href="{{ url('/admin/data/data-fasilitas-kesehatan/Lasalimu') }}">Lasalimu</a>
                                            
                                            <a class="nav-link" href="{{ url('/admin/data/data-fasilitas-kesehatan/Kapontori') }}">Wolowa</a>
                                            
                                            <a class="nav-link" href="{{ url('/admin/data/data-fasilitas-kesehatan/Wabula') }}">Wabula</a>
                                    ...
                                    <a class="nav-link" href="{{ route('data-perikanan-komodity') }}">Data Perikanan Komodity</a>
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="{{ route('input-perikanan-komodity') }}">Data Perikanan Komodity</a>
                                ...
                                <a class="nav-link" href="{{ route('input-perikanan-komodity') }}">Data Perikanan Komodity</a>
                                    ...
                                    <a class="nav-link" href="{{ route('input-perikanan-jenis') }}">Data Perikanan Jenis</a>

                  ...
                  <table class="w-100 mt-4" style="color: black" border="1">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="text-center">Mata Pencaharian</th>
                            <th scope="col" class="text-center">Jumlah Kartu Keluarga</th>
                            <th scope="col" class="text-center">Tahun</th>
                          </tr>
                    </thead>
                    <tbody>
                        @foreach ($capilmp as $fasilitas_kesehatan)
                        <tr>
                          <th scope="row" class="text-center">{{ $loop->iteration }}</th>
                          <td class="text-center">{{ $fasilitas_kesehatan->kecamatan }}</td>  
                          <td class="text-center">{{ $fasilitas_kesehatan->matapencaharian }}</td>
